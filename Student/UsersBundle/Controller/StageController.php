...
use Student\UsersBundle\Entity\Stage;
use Student\UsersBundle\Form\StageType;
...
class StageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StudentUsersBundle:Stage')->findAll();

        return $this->render('StudentUsersBundle:Stage:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('StudentUsersBundle:Stage:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StudentUsersBundle:Stage')->find($id);
        ...
        return $this->render('StudentUsersBundle:Stage:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('StudentUsersBundle:Stage:edit.html.twig', array(
            'entity'      => $entity,
