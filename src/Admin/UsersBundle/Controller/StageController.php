...
use Admin\UsersBundle\Entity\Stage;
use Admin\UsersBundle\Form\StageType;
...
class StageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AdminUsersBundle:Stage:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('Stage_show', array('id' => $entity->getIdStage())));
        }

        return $this->render('AdminUsersBundle:Stage:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminUsersBundle:Stage')->find($id);
        ...
        return $this->render('AdminUsersBundle:Stage:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdminUsersBundle:Stage:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new StageType(), $entity, array(
            'action' => $this->generateUrl('Stage_update', array('id' => $entity->getIdStage())),
            'method' => 'PUT',
        ));
